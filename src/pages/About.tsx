...
// Default content when CMS page is not available
const defaultValues = [
  { icon: CheckCircle2, title: 'اصالت', description: 'تمامی محصولات ما ۱۰۰٪ اورجینال و با بالاترین کیفیت هستند' },
  { icon: Zap, title: 'نوآوری', description: 'طراحی‌های منحصر به فرد و مدرن برای استایل روز شما' },
  { icon: Users, title: 'جامعه', description: 'ساختن یک جامعه از افراد با سبک زندگی فعال و پویا' },
  { icon: Heart, title: 'کیفیت', description: 'استفاده از بهترین مواد اولیه و دقت در تولید' }
];
...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{page?.metaTitle || 'درباره ما'} | TM-BRAND</title>
        <meta name="description" content={page?.metaDescription || 'درباره TM-BRAND - برند پوشاک استریت‌ویر و اسپرت با کیفیت پرمیوم'} />
      </Helmet>
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center" dir="rtl">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
                {page?.title || 'استایل استریت برای'}
                <span className="text-primary block">نسل جدید</span>
              </h1>
              <p className="text-xl text-muted-foreground leading-relaxed">
                {page?.excerpt || 'TM-BRAND یک برند اصیل و مدرن پوشاک استریت‌ویر و اسپرت است که با تمرکز بر کیفیت، طراحی منحصر به فرد و راحتی، محصولاتی را برای نسل جوان و سبک‌زندگی پویا ارائه می‌دهد.'}
              </p>
            </div>
          </div>
        </section>
        ...
        {page?.content && (
          <section className="py-16 md:py-24">
            <div className="container mx-auto px-4">
              <div 
                className="max-w-4xl mx-auto prose prose-lg prose-headings:text-foreground prose-p:text-muted-foreground prose-strong:text-foreground prose-a:text-primary"
                dir="rtl"
